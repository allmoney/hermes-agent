...
def test_format_footer_all_fields(monkeypatch, tmp_path):
    ...
    assert out == "gpt-5.4 · 68% (68k/100k) · ~/projects/hermes"
...
def test_format_footer_latency_in_field_order(monkeypatch, tmp_path):
    ...
    assert out == "gpt-5.4 · 68% (68k/100k) · 1m05s · ~"
...
@pytest.mark.parametrize(
    ...
    [
        ("openai/gpt-5.4", 50_247, 1_000_000, "/var/data", "gpt-5.4 · 5% (50k/1000k) · /var/data"),
        ("claude-opus-4-8", 68_000, 100_000, "/var/data", "claude-opus-4-8 · 68% (68k/100k) · /var/data"),
        ("m", 0, None, "/var/data", "m · /var/data"),
        ("", 10, 100, "/var/data", "10% (10/100) · /var/data"),
        ("m", 10, 100, "", "m · 10% (10/100)"),
    ],
)
...
def test_default_build_footer_line_ignores_turn_seconds(monkeypatch):
    ...
    assert baseline == "gpt-5.4 · 5% (50k/1000k) · /var/data"
